...
```{r conjugation counts, echo=FALSE}
conj_num<-function(x){
...
```{r sentence length, warning = FALSE}
...
```{r longer than 43, warning = FALSE}
...
```{r rhetorical question, warning = FALSE}
...
```{r adjective counts, warning = FALSE}
...
```{r conjugation counts, warning = FALSE}
...
```{r negation counts, warning = FALSE}
